  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-screen px-4">
        ...
        {/* Continue Button */}
        <button className="bg-teal-500 hover:bg-teal-600 text-white text-lg md:text-xl px-8 py-4 rounded-full transition-all duration-300 font-medium flex items-center justify-center gap-2">
          <span>Continue</span>
